...
public class ViewPagerIndicatorView extends LinearLayout implements TabIndicatorView.OnIndicateChangeListener, OnPageChangeListener {
	...
	private OnPageIndexListener pageListener;
	

	public void setPageListener(OnPageIndexListener pageListener) {
	...
	public interface OnPageIndexListener{
		public void onCurrentPage(int current);
	}
	...
	public void onPageSelected(int position) {
		...
		if(null != pageListener){
			pageListener.onCurrentPage(position);
		}
	}
